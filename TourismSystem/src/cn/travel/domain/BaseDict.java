...
public class BaseDict {
	 ...
	 * `dict_sort` int(10) DEFAULT NULL COMMENT '排序字段', `dict_enable` char(1)
	 * NOT NULL COMMENT '1:使用 0:停用', `dict_memo` varchar(64) DEFAULT NULL
	 * COMMENT '备注', PRIMARY KEY (`dict_id`) ) ENGINE=InnoDB DEFAULT
	 * CHARSET=utf8;
	 */
